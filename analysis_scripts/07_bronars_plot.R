...
AI_plot <- ggplot(df, mapping = aes(AI)) +
  ...
  geom_vline(xintercept = AI_quantiles[1], lty=2, linewidth=1.1)+
  geom_vline(xintercept = AI_quantiles[2], lty=1, linewidth=1.1)+
  geom_vline(xintercept = AI_quantiles[3], lty=2, linewidth=1.1)+
  xlim(0,1)+
  ylim(0, 3000)+
  xlab("CCEI")+
